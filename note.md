...
完成Tlog-P图的数据生产业务运行。（年后第一周）
太阳能子系统数据生产业务运行。（年后第一周）
大雾集合预报数据生产业务运行。（年后第一周）
推进大风和降水产品的切图发布和稳定运行。（年后第一周）
完成培训计划的编写。（年后第一周） 

完成Tlog-P图的数据生产业务运行。（80%）
太阳能子系统数据生产业务运行。（50%）
大雾集合预报数据生产业务运行。（80%）
完成台风定位定强的改造。（100%）
推进大风和降水产品的切图发布和稳定运行。（30%）
完成培训计划的编写。（10%） 

推进Tlog-P图的数据生产业务运行。（3月第一周）
太阳能子系统数据生产业务运行。（3月第一周）
大雾集合预报数据生产业务运行。（3月第一周）
推进大风和降水产品的切图发布和稳定运行。（3月第一周）
完成培训计划的编写。（3月第一周） 
...
# ads 回款
【风云四号科研试验卫星地面应用系统工程应用与示范系统(ADS)产品应用软件项目】
 2021年预计回款 总计303.2万：
 1. 风云四号科研试验卫星地面应用系统工程应用与示范系统(ADS)产品应用软 件总价款为人民币壹仟伍佰壹拾陆万元整(¥1516 万元整),其支付拨款阶段为:
 2. 合同签署后 10 个工作日内,甲方向乙方支付合同款的 20%,即人民币叁佰零叁万贰仟元整(¥303.2 万元整);
 3. 软件需求分析通过评审后 10 个工作日内,甲方向乙方支付合同款的 15%,即人民币贰佰贰拾柒万肆仟元整(¥227.4 万元整);
 4. 软件算法通过评审后 10 个工作日内,甲方向乙方支付合同款的 20%, 即人民币叁佰零叁万贰仟元整(¥303.2 万元整);
 5. 软件概要设计通过评审后 10 个工作日内,甲方向乙方支付合同款的20%,即人民币叁佰零叁万贰仟元整(¥303.2 万元整);
 6. 项目通过验收后,甲方向乙方支付合同款的 20%,即人民币叁佰零叁万贰仟元整(¥303.2 万元整);
 7. 保修期执行一年后,甲方向乙方支付合同款的 5%,即人民币柒拾伍万捌仟元整(¥75.8 万元整)。
